...
exports.parseSearchQuery = async (query) => {
  try {
    const prompt = `Bạn là AI phân tích yêu cầu tìm kiếm phòng trọ. Phân tích câu sau và trả về JSON với cấu trúc:
...
Trả về JSON theo format SAU (CHÍNH XÁC):
{
  ...
  "location": "tên quận/huyện hoặc rỗng",
  ...
  "summary": "Tóm tắt ngắn gọn yêu cầu của người dùng"
}

Lưu ý:
- propertyType: phong-tro, nha-nguyen-can, can-ho, chung-cu-mini, homestay
- location: tên quận/huyện (VD: "Quận 1", "Gò Vấp", "Tân Bình")
