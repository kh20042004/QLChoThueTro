...
// ===================================
// 17. LOAD FEATURED PROPERTIES - Load phòng nổi bật
// ===================================
...
function createPropertyCard(property) {
    ...
    return `
        <div class="bg-white/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 property-card">
            <div class="relative">
