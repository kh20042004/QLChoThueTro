            ...
            <div class="p-5">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-2">
                        <button onclick="showPropertyLocation('${property._id}', ${property.location?.coordinates?.[1] || 0}, ${property.location?.coordinates?.[0] || 0}, '${property.title.replace(/'/g, "\\'")}')" 
...
function showPropertyLocation(propertyId, lat, lng, title) {
