            ...
            <div class="p-5">
                ...
                <div class="mb-3">
                    <p class="text-sm text-gray-700 font-medium mb-1">
                        <i class="fas fa-map-marker-alt mr-1 text-red-500"></i>${property.location?.address || 'Chưa cập nhật'}
                    </p>
                    <p class="text-xs text-gray-500 ml-5">
                        ${property.location?.ward ? property.location.ward + ', ' : ''}${property.location?.district || ''}, ${property.location?.province || ''}
                    </p>
                </div>
