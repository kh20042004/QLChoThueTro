...
function displayAISearchResult(filters, summary, properties, count) {
    ...
    if (count > 0) {
        ...
        // Hiển thị danh sách phòng gợi ý
        ...
        properties.forEach(prop => {
            ...
            html += `
                <div class="flex gap-3 bg-white border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-pointer" onclick="window.open('/properties/${prop._id}', '_blank')">
                    <img src="${image}" alt="${prop.title}" class="w-24 h-24 object-cover rounded-lg flex-shrink-0">
                    <div class="flex-1 min-w-0">
                        <h5 class="font-semibold text-gray-900 truncate">${prop.title}</h5>
                        ...
                        <div class="mt-1">
                            <span class="text-lg font-bold text-red-600">${price} triệu</span>
