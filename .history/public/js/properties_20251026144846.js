...
function setupEventListeners() {
    // Search form submit - chỉ filter khi bấm nút tìm kiếm
    ...
    // Sort - Sắp xếp có thể thay đổi ngay (không cần submit)
...
function filterProperties() {
    ...
    console.log('Filtering with:', { selectedType, selectedLocation, selectedPrice });
    ...
    console.log('Filtered results:', filteredProperties.length, 'out of', allProperties.length);
