    ...
    async sendMessage() {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Nếu AI đã hoàn thành tìm kiếm
                if (data.data.isComplete) {
                    setTimeout(() => {
                        this.addMessage('ai', '✅ Tìm kiếm hoàn tất! Bạn có thể xem chi tiết các phòng đề xuất bằng cách click vào "Xem tất cả kết quả" bên dưới.');
                    }, 500);
                }
            } else {
