...
const sampleProperties = [
  {
    ...
    amenities: ['Wifi', 'Điều hòa', 'Giữ xe', 'Nóng lạnh', 'An ninh 24/7'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      city: 'TP. Hồ Chí Minh',
      full: '456 Hoàng Văn Thụ, Phường 4, Quận Tân Bình, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Điều hòa', 'Giữ xe', 'Bếp riêng', 'Nóng lạnh', 'Máy giặt', 'Ban công', 'An ninh 24/7'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      city: 'TP. Hồ Chí Minh',
      full: '789 Võ Văn Ngân, Phường Linh Chiểu, Quận Thủ Đức, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Điều hòa', 'Gara ô tô', 'Bếp', 'Nóng lạnh', 'Máy giặt', 'Ban công', 'An ninh', 'Nội thất đầy đủ'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      city: 'TP. Hồ Chí Minh',
      full: '321 Xô Viết Nghệ Tĩnh, Phường 21, Quận Bình Thạnh, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Giữ xe', 'Nóng lạnh', 'An ninh'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      district: 'Quận 7',
      city: 'TP. Hồ Chí Minh',
      full: '234 Nguyễn Hữu Thọ, Phường Tân Hưng, Quận 7, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Điều hòa', 'Giữ xe', 'Bếp', 'Nóng lạnh', 'Máy giặt', 'Ban công', 'An ninh 24/7', 'Hồ bơi', 'Gym'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      city: 'TP. Hồ Chí Minh',
      full: '567 Quang Trung, Phường 10, Quận Gò Vấp, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Giữ xe', 'Nóng lạnh', 'Máy giặt chung', 'An ninh'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      district: 'Quận 3',
      city: 'TP. Hồ Chí Minh',
      full: '888 Nam Kỳ Khởi Nghĩa, Phường Võ Thị Sáu, Quận 3, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Điều hòa', 'Giữ xe', 'Bếp', 'Nóng lạnh', 'Máy giặt', 'Ban công', 'Reception 24/7', 'Dọn phòng', 'Nội thất 5 sao'],
    images: [
  ...
  },
  {
    ...
    address: {
      ...
      district: 'Quận 10',
      city: 'TP. Hồ Chí Minh',
      full: '159 Sư Vạn Hạnh, Phường 12, Quận 10, TP. Hồ Chí Minh'
    },
    amenities: ['Wifi', 'Điều hòa', 'Giữ xe', 'Nóng lạnh', 'An ninh', 'Gác lửng'],
    images: [
